...
9. [Frontend Flutter](#frontend-flutter)
...
│   └── traffic_sensor.dart  # Modelo de sensor de tráfego
...
│   ├── interscity_integration_screen.dart
│   ├── new_interscity_integration_screen.dart
...
#### 🔗 Integração InterSCity
- **Tela específica** para integração com InterSCity
- **Configuração** de sensores e dados
